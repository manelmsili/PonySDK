...
public class BootstrapServlet extends HttpServlet {
	...
	protected void handlePonyResource(final HttpServletRequest request, final HttpServletResponse response)
			throws IOException {
		try {
	...
	protected void writeIndexHTML(final BufferedWriter writer) throws IOException {
		...
		writer.append("<script type=\"text/javascript\" src=\"script/supp.js\"></script>");
		writer.newLine();
